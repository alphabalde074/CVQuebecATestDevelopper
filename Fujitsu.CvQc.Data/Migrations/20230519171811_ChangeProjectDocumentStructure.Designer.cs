...
namespace Fujitsu.CvQc.Data.Migrations
{
    ...
    [Migration("20230519171811_ChangeProjectDocumentStructure")]
    partial class ChangeProjectDocumentStructure
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fujitsu.CvQc.Data.Entities.Importation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Fujitsu.CvQc.Data.Entities.Document", b =>
                {
                    ...
                    b.HasOne("Fujitsu.CvQc.Data.Entities.Importation", null)
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("Fujitsu.CvQc.Data.Entities.Importation", b =>
                {
                    b.HasOne("Fujitsu.CvQc.Data.Entities.Project", "Project")
                        .WithOne("Importation")
                        .HasForeignKey("Fujitsu.CvQc.Data.Entities.Importation", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
